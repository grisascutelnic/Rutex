...
-- This is a fix for V18 if it wasn't applied correctly
...
-- Insert initial statistics if they don't exist
INSERT IGNORE INTO statistics (stat_key, stat_value) VALUES
